...
public class AirVRRaycaster : GraphicRaycaster {
    private static readonly List<AirVRRaycaster> _allRaycasters = new List<AirVRRaycaster>();

    public static List<AirVRRaycaster> GetAllRaycasters() {
