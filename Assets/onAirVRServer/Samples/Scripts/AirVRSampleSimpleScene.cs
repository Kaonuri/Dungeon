...
public class AirVRSampleSimpleScene : MonoBehaviour, AirVRCameraRigManager.EventHandler {
    ...
    void Update() {
        ...
        else if (Input.GetKeyDown(KeyCode.T) || AirVRInput.GetDown(cameraRig, AirVRInput.Touchpad.Button.Back) || AirVRInput.GetDown(cameraRig, AirVRInput.Gamepad.Button.B)) {
